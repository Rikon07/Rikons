  ...
  return (
    <>
      <motion.button
        ...
        className={`w-9 h-9 rounded-full flex items-center justify-center transition-colors duration-300 focus:outline-none
          ${theme === "dark"
            ? " text-[#dce7ec] hover:bg-[#D0E7F9] hover:text-[#0F172A]"
